...
def _get_parser(parser_mod_name: str) -> ModuleType:
    ...
    modpath: str = 'jcparsers.' if parser_cli_name in local_parsers else 'katti.jc.parsers.'
...
def parse(
    ...
    **kwargs
    ...
    Alternatively, a parser module object can be supplied:
        ...
        >>> import katti.jc
        >>> import katti.jc.parsers.date as jc_date
